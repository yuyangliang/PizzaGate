...
class DomainParser():
	...
	def get_domaininfo(self):
		...
		self.article_selector, self.datetime, self.unixtime, self.title_selector, self.author_selector, self.links_selector, self.likes = getattr(self, name)()
	...
	def reddit_main(self):
		...
		return (article_selector, date_time, unixtime, title_selector, author_selector, links_selector, likes)		
